...
interface StitcherSelectiveVisitor<T> : StitcherVisitor<T> {
    ...
    override fun visitSemantic(o: PsiPredicate.Semantic): T = throw UnsupportedOperationException()
    override fun visitString(o: PsiPredicate.String): T = throw UnsupportedOperationException()
}