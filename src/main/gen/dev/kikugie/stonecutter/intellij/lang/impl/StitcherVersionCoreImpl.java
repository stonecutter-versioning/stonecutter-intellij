...
public class StitcherVersionCoreImpl extends ASTWrapperPsiElement implements StitcherVersionCore {

  public StitcherVersionCoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StitcherVisitor visitor) {
    visitor.visitVersionCore(this);
  }
