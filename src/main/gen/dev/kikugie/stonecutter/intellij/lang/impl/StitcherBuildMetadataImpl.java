...
public class StitcherBuildMetadataImpl extends ASTWrapperPsiElement implements StitcherBuildMetadata {

  public StitcherBuildMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StitcherVisitor visitor) {
    visitor.visitBuildMetadata(this);
  }
