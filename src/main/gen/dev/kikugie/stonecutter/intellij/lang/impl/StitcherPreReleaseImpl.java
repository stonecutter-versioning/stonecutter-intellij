...
public class StitcherPreReleaseImpl extends ASTWrapperPsiElement implements StitcherPreRelease {

  public StitcherPreReleaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StitcherVisitor visitor) {
    visitor.visitPreRelease(this);
  }
