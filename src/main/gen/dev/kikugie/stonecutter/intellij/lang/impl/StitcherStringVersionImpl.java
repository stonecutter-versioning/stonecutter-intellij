...
public class StitcherStringVersionImpl extends ASTWrapperPsiElement implements StitcherStringVersion {

  public StitcherStringVersionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StitcherVisitor visitor) {
    visitor.visitStringVersion(this);
  }
