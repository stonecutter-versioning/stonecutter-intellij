...
public class StitcherSwapIdImpl extends ASTWrapperPsiElement implements StitcherSwapId {

  public StitcherSwapIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StitcherVisitor visitor) {
    visitor.visitSwapId(this);
  }
