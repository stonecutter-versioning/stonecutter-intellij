...
public class StitcherSwapImpl extends ASTWrapperPsiElement implements StitcherSwap {

  public StitcherSwapImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StitcherSwapId getSwapId() {
    return findChildByClass(StitcherSwapId.class);
  }
